...
class vanilla : public one_asset<_M, _Ex>
{
public:
...
protected:
  ...
  _QV_CONSTEXPR_SCOPE
  vanilla(const _M& model,
          const data_type y_target,
          data_type m,
          data_type n) noexcept
    : base(model.S(),
           model.K(),
           model.T(),
           model.r(),
...
public:
  ...
  _QV_CONSTEXPR_SCOPE
  void set_implied_volatility(const data_type y_target,
                              data_type m,
                              data_type n) noexcept
  {
  ...
  _QV_CONSTEXPR_SCOPE
  data_type implied_volatility(const data_type y_target,
                               data_type m,
                               data_type n) const noexcept
  {
    return implied_volatility(model(), y_target, m, n);
  }

  _QV_CONSTEXPR_SCOPE
  data_type implied_volatility(const _M& model,
                               const data_type y_target,
                               data_type m,
                               data_type n) const noexcept
  {
    ...
    data_type y = _M::compute::template exercice<_Ex>(
        model.S(), model.K(), model.T(), model.r(), x);
    ...
    do
    {
      ...
      y = _M::compute::template exercice<_Ex>(
          model.S(), model.K(), model.T(), model.r(), x);
