...
_BEGIN_NAMESPACE_INSTRUMENT
  ...
  protected:
    ...
    _QV_CONSTEXPR_SCOPE
    greeks_base(const _T&... args) noexcept :
      _model(args...)
    {}
    
    _QV_CONSTEXPR_SCOPE
		explicit greeks_base(const model_type& model) noexcept :
      _model(model) 
		{}
    
    _QV_CONSTEXPR_SCOPE
		explicit greeks_base(model_type&& model) noexcept :  
  ...
  public:
    ...
    _QV_CONSTEXPR_SCOPE
    const _M& model() const noexcept
    { return _model; }
    
    _QV_CONSTEXPR_SCOPE
    void set_model(const _M& model) noexcept
    { _model = model; }

    _QV_CONSTEXPR_SCOPE
    void set_model(_M&& model) noexcept
    { _model = std::move(model); }
  ...
  public:
    ...
    _QV_CONSTEXPR_SCOPE
    _R delta() const noexcept
    { return _data.delta; }
    
    _QV_CONSTEXPR_SCOPE
    _R gamma() const noexcept
    { return _data.gamma; }
    
    _QV_CONSTEXPR_SCOPE
    _R theta() const noexcept
    { return _data.gamma; }
    
    _QV_CONSTEXPR_SCOPE
    _R vega() const noexcept
    { return _data.vega; }
    
    _QV_CONSTEXPR_SCOPE
    _R rho() const noexcept
    { return _data.rho; }
     
    _QV_CONSTEXPR_SCOPE 
    void set_delta(const _R delta) noexcept
    { _data.delta = delta; }
    
    _QV_CONSTEXPR_SCOPE
    void set_gamma(const _R gamma) noexcept
    { _data.gamma = gamma; }
    
    _QV_CONSTEXPR_SCOPE
    void set_theta(const _R theta) noexcept
    { _data.theta = theta; }
    
    _QV_CONSTEXPR_SCOPE
    void set_vega(const _R vega) noexcept
    { _data.vega = vega; }
    
    _QV_CONSTEXPR_SCOPE
    void set_rho(const _R rho) noexcept
    { _data.rho = rho; }
