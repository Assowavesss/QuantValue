...
struct is_variadic_convertible_to<T, Head, Tail...>
  : std::conditional_t<std::is_convertible_v<T, Head>,
...
struct is_variadic_convertible_to_real
  : is_variadic_convertible_to<T, float, double, long double>
{
};
...
template<typename T>
using is_convertible_real =
    typename std::enable_if_t<is_variadic_convertible_to_real_v<T>>;

template<typename T>
using is_convertible_integral =
    typename std::enable_if_t<is_variadic_convertible_to_integral_v<T>>;
